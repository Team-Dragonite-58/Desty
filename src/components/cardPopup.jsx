...
export default function CardPopup() {
  ...
  return (
    <div className="modal flex justify-center items-center rounded-xl">
        ...
        <div className='flex flex-col'>
          <div className='flex flex-row justify-between border-b border-b-[#A8DADC] p-5'>
            ...
            <Popup
              ...
              >
              {() => (
                  <div className='fixed flex flex-col text-[#F1FAEE] gap-1'>
                    <button type='button' className='w-24 h-10 rounded-md bg-[#457B9D]'>Undecided</button>
                    <button type='button' className='w-24 h-10 rounded-md bg-[#E63946]'>Upcoming</button>
                    <button type='button' className='w-24 h-10 rounded-md bg-[#1D3557]'>Visited</button>
                  </div>
                )
              }
            </Popup>
          ...
          <ul>
            <li className='flex justify-between items-center border-b border-b-[#A8DADC] p-5'>
              <button>
                <img src={require('../assets/editbutton.png')} alt="pencil in a box" />
              </button>
          ...
          <form className='flex  items-center justify-center'>
            <input className='w-full bg-[#CDD9CE] p-2 m-5 rounded-md' type='text' placeholder='Add a line...'/>
          </form>
        </div>
      </div>
    </div>
